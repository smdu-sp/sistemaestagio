      ...
      <div class="row">
        ...
        <div class="col-md-4 d-flex flex-column justify-content-end">
          <div class="form-group">
            ...
            <botao-excel :nome = "selecao"></botao-excel>
          </div>
        </div>
      </div>
      <div id="divTabela">
          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              >
                ...
                <td>{{ estagiarioContratado.nome.toUpperCase() }}</td>
        ...
        <div v-if="selecao === 'Saídas'">
          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              >
                <th scope="row">{{ indice + 1 }}</th>
                <td>{{ estagiarioDesligado.nome.toUpperCase() }}</td>
        ...
        <div v-if="selecao === 'Renovação'">
          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              >
                <th scope="row">{{ indice + 1}}</th>
                <td>{{ estagiarioRenovado.nome.toUpperCase() }}</td>
                ...
                <td
                  v-if="estagiarioRenovado.dt_inicio_3_aditivo"
                >{{ estagiarioRenovado.dt_inicio_3_aditivo | dataFormatada}}</td>
                <td
                  v-else-if="estagiarioRenovado.dt_inicio_2_aditivo"
                >{{ estagiarioRenovado.dt_inicio_2_aditivo | dataFormatada}}</td>
                <td v-else>{{ estagiarioRenovado.dt_inicio_1_aditivo | dataFormatada }}</td>
              </tr>
  ...
  methods: {
    ...
    salvaEstagiariosDesligados30dias() {
      ...
      for (let i in this.estagiarios) {
        ...
        let novaDataFormatada = novaData.setDate(novaData.getDate());
        if (
          novaDataFormatada >= dataAtualMenos30Dias &&
          novaDataFormatada <= dataAtualTime
        ) {
    ...
    salvaEstagiariosRenovados30dias() {
      ...
      for (let i in this.estagiarios) {
        ...
        if (typeof dataEstagiario1Aditivo == "null") {
          ...
          var novaData1Formatada = novaData1Aditivo.setDate(
            novaData1Aditivo.getDate()
          );
        }

        if (typeof dataEstagiario2Aditivo == "null") {
          var novaData2Aditivo = new Date(dataEstagiario2Aditivo);
          var novaData2Formatada = novaData2Aditivo.setDate(
            novaData2Aditivo.getDate()
          );
        }
        ...
        if (typeof dataEstagiario3Aditivo == "null") {
          ...
          var novaData3Formatada = novaData3Aditivo.setDate(
            novaData3Aditivo.getDate()
          );
        }
